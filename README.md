...
| Mottaker       | Identen til mottaker av beløpet. Dette vil tilsvare RM. I enkelte tilfeller, slik som ved gebyr, så vil mottakerIdent settes til NAVs aktørnummer `80000345435`.                                                                                                                                                                                                                                                                                                                                               |
...
| OpphørendeOppdragsperiode | Viser til om oppdragsperioden er opphørende for oppdraget. Dette vil forhindre at nye konteringer genereres ved påløpskjøring.                                                                                                                   |
...
### Databaseversjonering med flyway
Bidrag-regnskap benytter seg av flyway for å oppdatere databasen.<br>
V0.x.x er initiell opprett av database med tilganger og mulighet til å resette databasen ved sletting av flyway historikk. Primært for bruk til lokal utvikling.<br>
V1.x.x er oppsett av initielle tabeller og endringer opp mot prodsetting.<br>
V2.x.x er endringer fra prodsetting av bidrag-regnskap og frem mot at regnskap er tatt i bruk.<br>
V3.x.x er endringer fra etter at regnskap er tatt i bruk av Elin.<br>
<br>Flywayscriptene finnes her: [db/migration](src/main/resources/db/migration).
