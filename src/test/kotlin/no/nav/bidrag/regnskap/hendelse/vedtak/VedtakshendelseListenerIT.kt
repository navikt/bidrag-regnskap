...
import no.nav.bidrag.domain.enums.StonadType.BIDRAG
import no.nav.bidrag.domain.enums.StonadType.BIDRAG18AAR
import no.nav.bidrag.domain.enums.StonadType.EKTEFELLEBIDRAG
import no.nav.bidrag.domain.enums.StonadType.FORSKUDD
import no.nav.bidrag.domain.enums.StonadType.MOTREGNING
import no.nav.bidrag.domain.enums.StonadType.OPPFOSTRINGSBIDRAG
